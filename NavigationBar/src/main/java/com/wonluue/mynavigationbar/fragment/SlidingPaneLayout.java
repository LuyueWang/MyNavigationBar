 ...
 * navigation drawer pattern instead. ({@link = DrawerLayout}
...
public class SlidingPaneLayout extends ViewGroup {
     ...
     */
    private int mSliderFadeColor = SlidingPaneLayout.DEFAULT_FADE_COLOR;
    ...
    public SlidingPaneLayout(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingPaneLayout(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        this.mDragHelper.setMinVelocity(SlidingPaneLayout.MIN_FLING_VELOCITY * density);
    }
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        if (childCount > 2) {
            Log.e(SlidingPaneLayout.TAG, "onMeasure: More than two child views are not supported.");
        }
        ...
        if (Build.VERSION.SDK_INT >= 11) { // HC
            ...
            if (lp.dimWhenOffset && (this.mSlideOffset > 0)) {
                ...
                if (cache != null && !cache.isRecycled()) {
                    ...
                    Log.e(SlidingPaneLayout.TAG, "drawChild: child view " + child + " returned null drawing cache");
                    result = super.drawChild(canvas, child, drawingTime);
                }
            } else {
                if (child.isDrawingCacheEnabled()) {
    ...
    private void invalidateChildRegion(final View v) {
        SlidingPaneLayout.IMPL.invalidateChildRegion(this, v);
    }
...
//			return ((LayoutParams) child.getLayoutParams()).slideable;
        ...
        public void onViewDragStateChanged(final int state) {
            if (SlidingPaneLayout.this.mDragHelper.getViewDragState() == ViewDragHelper.STATE_IDLE) {
        ...
        public void onViewReleased(final View releasedChild, final float xvel, final float yvel) {
            ...
            if ((xvel > 0) || ((xvel == 0) && (SlidingPaneLayout.this.mSlideOffset > 0.5f))) {
        ...
        public int clampViewPositionHorizontal(final View child, final int left, final int dx) {
            final LayoutParams lp = (LayoutParams) SlidingPaneLayout.this.mSlideableView.getLayoutParams();
            final int leftBound = SlidingPaneLayout.this.getPaddingLeft() + lp.leftMargin;
            final int rightBound = leftBound + SlidingPaneLayout.this.mSlideRange;
    ...
    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        @Override
        public void invalidateChildRegion(final SlidingPaneLayout parent, final View child) {
    ...
    static class SlidingPanelLayoutImplJB extends SlidingPanelLayoutImplBase {
        ...
        SlidingPanelLayoutImplJB() {
            ...
            try {
                ...
                Log.e(SlidingPaneLayout.TAG, "Couldn't fetch mRecreateDisplayList field; dimming will be slow.", e);
            }
        }
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(final View host, final AccessibilityNodeInfoCompat info) {
            ...
            final int childCount = SlidingPaneLayout.this.getChildCount();
            for (int i = 0; i < childCount; i++) {
